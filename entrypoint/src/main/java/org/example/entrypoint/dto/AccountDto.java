 ...
 */
@Schema(description = "DTO for account data")
public class AccountDto {
    @Schema(description = "The unique identifier of the account", example = "1")
    private Long id;
    @Schema(description = "The ID of the user who owns the account", example = "1")
    private Long userId;
    ...
    @Schema(description = "The timestamp when the account was created", example = "1678886400000")
    ...
    public AccountDto(Long id, Long userId, String accountNumber, String accountType, Double balance, String currency, Boolean isActive, Long createdAt) {
        this.id = id;
        this.userId = userId;
    ...
    public static class Builder {
        ...
        public AccountDto build() {
            return new AccountDto(id, userId, accountNumber, accountType, balance, currency, isActive, createdAt);
        }
    }
}