...
public class Card {
    ...
    public Card(Long id, Long accountId, String cardNumber, String cardType, String cardholderName, String expirationDate, String cvv, Boolean isActive, Long createdAt) {
        this.id = id;
    ...
    public static class Builder {
        ...
        public Card build() {
            return new Card(id, accountId, cardNumber, cardType, cardholderName, expirationDate, cvv, isActive, createdAt);
        }
    }
}